...
class TruckVideo extends StatefulWidget {
  ...
  final from;
  @override
  _TruckVideoState createState() => _TruckVideoState();
}

class _TruckVideoState extends State<TruckVideo> {
  ...
  Widget transition1() {
    var screenSize = MediaQuery.of(context).size;
    return Positioned(
        left: Utils.getVideoScreenWidth(screenSize) * 0.34,
        top: Utils.getVideoScreenHeight(screenSize) * 0.72,
        child: Stack(
          children: [
            InkWell(
              onTap: () async {
  ...
  Widget transition2() {
    var screenSize = MediaQuery.of(context).size;
    return Positioned(
        left: Utils.getVideoScreenWidth(screenSize) * 0.49,
        top: Utils.getVideoScreenHeight(screenSize) * 0.6,
        child: Stack(
          children: [
            InkWell(
              onTap: () async {
