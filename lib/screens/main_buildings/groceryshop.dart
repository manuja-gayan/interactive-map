...
class GroceryShopVideo extends StatefulWidget {
  ...
  final from;
  @override
  _GroceryShopVideoState createState() => _GroceryShopVideoState();
}

class _GroceryShopVideoState extends State<GroceryShopVideo> {
                ...
                children: [
                  ...
                  show
                      ? Positioned(
                          ...
                          child: Container(
                            width:
                                Utils.getVideoScreenWidth(screenSize) * 0.075,
                            height:
